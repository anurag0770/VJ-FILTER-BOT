...
API_ID = int(environ.get('API_ID', '25400715'))
API_HASH = environ.get('API_HASH', '851f9c02bb4889879be7957937f75a30')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1922942698').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002450559391'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002282912684').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://alltotalexposed830:<RPH7zHMFf22gY08F>@bots.7owui.mongodb.net/?retryWrites=true&w=majority&appName=Bots")   # IF Multiple Database Is False Then Fill Only This Database Url.
